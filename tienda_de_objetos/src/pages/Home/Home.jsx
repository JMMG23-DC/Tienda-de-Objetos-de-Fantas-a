...
export const Home = () =>{
    ...
    // Lógica para las 3 categorías más vendidas
            ...
            <section className="seccion_producto">
                ...
                <div className="productos-flex">
                    {top3Categorias.map((categoriaInfo) => (
                        <article className="producto-card" key={categoriaInfo.categoria}> {/* Key corregido */}
                            <img src={categoriaInfo.imagen} alt={categoriaInfo.categoria} /> {/* Ahora 'imagen' existe */}
