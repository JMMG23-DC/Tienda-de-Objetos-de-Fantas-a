...
export default function AdminDashboard({ onShowUserList, onShowProductList, onShowAddCategory }) {
  ...
  return (
    <div style={{ maxWidth: 500, margin: "2rem auto", padding: "2rem", background: "#fff", borderRadius: 8, boxShadow: "0 2px 8px #0002" }}>
      ...
      <button style={{ marginTop: "1rem" }} onClick={typeof onShowAddCategory === 'function' ? onShowAddCategory : undefined}>Agregar nueva categoría</button>
    </div>
  );
}
